...
const calculateMonthlyIndustrialProcesses = async (userId) => {
  try {
    ...
    for (const submission of submissions) {
      ...
      const records = responses?.get("Scope1:DirectEmissions_IndustrialProcesses");
      ...
      for (const record of records) {
        ...
        // ✅ Check for duplicates including month
        const exists = await IndustrialProcessesEmissionModel.findOne({
          userId,
          month,
          industryType,
    ...
    console.error("calculateMonthlyIndustrialProcesses error:", error.message);
    return {};
  }
};

module.exports = { calculateMonthlyIndustrialProcesses };
